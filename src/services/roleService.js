...
export const ROLE_PERMISSIONS = {
  ...
  // ພະນັກງານຂາຍ - ເຫັນ ຂໍ້ມູນສິນຄ້າ, ປະເພດ, ຍີ່ຫໍ້, ບ່ອນຈັດວາງ, ໜ້ານຳເຂົ້າ, ໜ້ານຳອອກ, ລາຍງານສິນຄ້າ/ປະເພດ/ຍີ່ຫໍ້/ບ່ອນຈັດວາງ/ນຳເຂົ້າ/ນຳອອກ/ສັ່ງຊື້
  [ROLES.USER2]: [
    '/dashboard',
    '/Manage_data',   // ແຕ່ຈະສະແດງພຽງບາງເມນູຍ່ອຍ
    '/products',      // ຂໍ້ມູນສິນຄ້າ
    ...
    '/Buy',           // ສັ່ງຊື້ສິນຄ້າ
    '/Purchase-Orders', // ລາຍການສັ່ງຊື້
    '/reports',       // ລາຍງານ (ແຕ່ຈະເຫັນບາງລາຍງານເທົ່ານັ້ນ)
    '/user-profile'   // ໜ້າຂໍ້ມູນໂປຣໄຟລ໌ ສ່ວນຕົວ
  ]
};
